    ...
    <header className="bg-orange-600 text-white">
          ...
          <Link href="/" className="hover:underline">
            <div className="flex items-center">
              <Image
                ...
                height={48}
              />
              <span className="font-bold">CỬA HÀNG BÁN SÁCH </span>
            </div>
          </Link>
      ...
      <div className="bg-slate-100 text-black py-2 shadow-sm">
        <div className="container mx-auto flex justify-center space-x-8">
          ...
          <Link href="/products" className="hover:text-orange-600 font-semibold">
            SẢN PHẨM
          </Link>
          <Link href="/about" className="hover:text-orange-600 font-semibold">
            VỀ CHÚNG TÔI
          </Link>
        </div>
      </div>
